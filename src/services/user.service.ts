...
const getCurrentUserService = async () => {
  try {
    ...
    console.log("response of getCurrentUser is", response);
    console.log("response.data of getCurrentUser is", response.data);
    return response.data;
  } catch (error: any) {
    throw new Error("Error while getting current user" + error.message);
  }
};
...
export { loginService, registerService, logoutService, getCurrentUserService };
